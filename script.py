...
nombre="General"
idDisco="teradiscoteca"
mesas=10 # Cambia este número para generar QR para mesas, ej: mesas=10
...
for i, link in enumerate(links):
    if i != 0:
        ...
        generate_qr_with_logo_and_general(link, logo_path, title, output_path)
